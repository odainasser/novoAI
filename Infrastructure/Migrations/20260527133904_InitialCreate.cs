    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EntityType = table.Column<int>(type: "int", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    BranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ComputerIp = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
                    PrinterIp = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
                    PaymentMachineIp = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Warehouses_Lookups_WarehouseTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_NameAr",
                table: "Devices",
                column: "NameAr");

            migrationBuilder.CreateIndex(
                name: "IX_Devices_NameEn",
                table: "Devices",
                column: "NameEn");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_NameAr",
                table: "Warehouses",
                column: "NameAr");

            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_NameEn",
                table: "Warehouses",
                column: "NameEn");

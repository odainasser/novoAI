...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260609095715_AddAssistantReportedAnswers")]
    partial class AddAssistantReportedAnswers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CashierWarehouse", b =>
                {
                    ...
                    b.HasKey("CashierId", "WarehouseId");

                    b.HasIndex("CashierId");

                    b.HasIndex("WarehouseId");

                    b.ToTable("CashierWarehouses", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<string>("UnitBarcode")
                        ...
                        .HasColumnName("SellingUnitBarcode");
                    ...
                    b.Property<string>("UnitNameAr")
                        ...
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("SellingUnitNameAr");

                    b.Property<string>("UnitNameEn")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("SellingUnitNameEn");
            ...
            modelBuilder.Entity("Domain.Entities.OrderRefund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.OrderRefundItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.PromotionUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PromotionId", "UnitId")
                        .IsUnique();

                    b.ToTable("PromotionUnits", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.OrderRefundItem", b =>
                {
                    b.HasOne("Domain.Entities.OrderRefund", "OrderRefund")
                        .WithMany("Items")

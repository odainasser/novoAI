...
{
    public Web.Models.Inventory.CreateGoodsReceivingNoteRequest Data { get; set; } = new();
    public string? Note { get; set; }
}

public class CreateInventoryAdjustmentRequest
{
    public Web.Models.Inventory.CreateStockAdjustmentRequest Data { get; set; } = new();
    public string? Note { get; set; }
}

public class CreateInventoryTransferRequest
{
    public Web.Models.Inventory.CreateStockTransferRequest Data { get; set; } = new();
    public string? Note { get; set; }
}
...
public class CreateSetLogisticsDetailsRequest
{
    ...
    public List<Web.Models.Units.UnitSupplierItem> Suppliers { get; set; } = new();
    public int LowStockThreshold { get; set; } = 10;
    public string? Note { get; set; }
}
